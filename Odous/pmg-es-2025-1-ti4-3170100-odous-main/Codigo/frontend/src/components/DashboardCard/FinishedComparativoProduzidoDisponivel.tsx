...
const FinishedComparativoProduzidoDisponivel: React.FC<Props> = ({
  data,
  loading,
}) => (
  <DashboardCardGraph title="Produzido OK x Disponível por Acabado">
    {loading ? (
      <div
        style={{
          height: 300,
...
export default FinishedComparativoProduzidoDisponivel;

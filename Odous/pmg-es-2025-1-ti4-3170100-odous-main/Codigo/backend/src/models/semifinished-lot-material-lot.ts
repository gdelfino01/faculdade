...
@Table
export default class SemifinishedLotMaterialLot extends Model<InferAttributes<SemifinishedLotMaterialLot>, InferCreationAttributes<SemifinishedLotMaterialLot>> {
    @PrimaryKey
    ...
    @BeforeCreate
    static async debitLot(instance: SemifinishedLotMaterialLot) {
    ...
    @BeforeDestroy
    static async creditLot(instance: SemifinishedLotMaterialLot) {
        const materialLot = await MaterialLot.findByPk(instance.materialLotId);
